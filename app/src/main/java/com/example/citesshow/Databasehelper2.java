...
public class Databasehelper2 extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME2="HR";
    ...
    public static  final  String TABLE01_COL8="NOTT";




    private static final String CREATE_TABLE_STATMENT ="CREATE TABLE "+TABLE01_NAME+" ("+TABLE01_COL8+" TEXT,"+TABLE01_COL1+" TEXT,"+TABLE01_COL2+" TEXT,"+TABLE01_COL3+" TEXT,"+TABLE01_COL4+" TEXT,"+TABLE01_COL5+" TEXT,"+TABLE01_COL6+" TEXT,"+TABLE01_COL7+" TEXT);" ;
